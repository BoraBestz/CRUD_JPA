...
public final class Pkcs12FileHelper {
    ...
    public static Certificate[] readFirstChain(InputStream p12FileName, char[] ksPass) throws KeyStoreException, IOException, CertificateException, NoSuchAlgorithmException {
        Certificate[] certChain = null;

        KeyStore p12 = KeyStore.getInstance("pkcs12");
        p12.load(p12FileName, ksPass);
    ...
    public static PrivateKey readFirstKey(InputStream p12FileName, char[] ksPass, char[] keyPass) throws KeyStoreException, IOException, CertificateException, NoSuchAlgorithmException, UnrecoverableKeyException {
        PrivateKey pk = null;
