...
@Entity
@Table(name = "com_company", schema = "conf", catalog = "etax")
public class ComCompanyEntity {
  ...
  public boolean equals(Object o) {
    ...
    ComCompanyEntity that = (ComCompanyEntity) o;

    if (companyId != that.companyId) {
      return false;
    }
    if (parentCompanyId != null ? !parentCompanyId.equals(that.parentCompanyId)
        : that.parentCompanyId != null) {
      return false;
    }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (parentCompanyId != null ? parentCompanyId.hashCode() : 0);
