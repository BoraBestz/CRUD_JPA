...
@Api(tags = "ComCompany")
@Slf4j
public class ComCompanyController extends LoggingService {
  ...
  @Autowired
  public void setComCompanyController(
  ...
  @PreAuthorize("isAuthenticated()")
  @GetMapping("/company")
  @ApiOperation(value = "Search ComCompany", response = ComCompanyDto.class, responseContainer = "List")
  @ApiResponses(
      value = {
  ...
  public ResponseEntity<ResponseModel> searchByCri(
    ...
    try {
      log.info("Start ComCompanyController.searchByCri()... ");
      ComCompanyDto dto = modelMapper.map(paramDto, ComCompanyDto.class);
      Page<ComCompanyDto> byCri = companyService.findByCri(dto);
      ...
      log.error("Error ComCompanyController.searchByCri()... " + e.getMessage());
  ...
  @ApiOperation(value = "Get ComCompany By Id", response = ComCompanyDto.class)
  @ApiResponses(
      value = {
        @ApiResponse(code = 400, message = "Something went wrong"),
        @ApiResponse(code = 403, message = "Access denied"),
  ...
  public ResponseEntity<ResponseModel> getById(@PathVariable("id") int id) {
    ...
    /// FOR LOG///
    try {
      log.info("Start ComCompanyController.getById()... ");
      ComCompanyDto dto = companyService.getById(id);
      ...
      log.error("Error ComCompanyController.getById()... " + e.getMessage());
      ...
      loggingServiceClient.activityLog(
          ...
          status);
      // ***END ACTIVITY LOG***//
      log.info("End ComCompanyController.getById()... ");
    }
  }
  ...
  @PreAuthorize("isAuthenticated()")
  @PostMapping("/company")
  @ApiOperation(value = "New ComCompany", response = void.class)
  @ApiResponses(
      value = {
        @ApiResponse(code = 400, message = "Something went wrong"),
        @ApiResponse(code = 403, message = "Access denied"),
  ...
  public ResponseEntity<ResponseModel> create(@RequestBody ComCompanyDto dto) {
    /// FOR LOG///
    int status = 0;
    String remark = "";
    /// FOR LOG///
    try {
      log.info("Start ComCompanyController.create()... ");

      int count = companyService.checkDuplicateCode(dto);
      ...
      dto.setStatus(1);
      ComCompanyEntity save = companyService.save(dto);

      /// FOR LOG///
      status = HttpStatus.OK.value();
      remark = "ID=" + save.getCompanyId() + " NAME=" + save.getName();
      /// FOR LOG///

      return HelperUtils.responseSuccess(save.getCompanyId());
    } catch (BusinessServiceException e) {
      ...
      loggingServiceClient.activityLog(
          ...
          status);
      // ***END ACTIVITY LOG***//
      log.info("End ComCompanyController.create()... ");
    }
  }
  ...
  @PreAuthorize("isAuthenticated()")
  @PutMapping("/company")
  @ApiOperation(value = "Update ComCompany", response = void.class)
  @ApiResponses(
      value = {
        @ApiResponse(code = 400, message = "Something went wrong"),
        @ApiResponse(code = 403, message = "Access denied"),
  ...
  public ResponseEntity<ResponseModel> update(@RequestBody ComCompanyDto dto) {
    /// FOR LOG///
    int status = 0;
    String remark = "";
    ComCompanyDto dtoFromDb = null;
    ComCompanyDto dtoFromDbCurrentData = null;
    /// FOR LOG///
    try {
      log.info("Start ComCompanyController.update()... ");
      dtoFromDb = companyService.getById(dto.getCompanyId());
      ...
      log.error("Error ComCompanyController.update()... " + e.getMessage());

      /// FOR LOG///
      status = e.getHttpStatus().value();
      remark = e.getMessage() + " ID=" + dto.getCompanyId();
      /// FOR LOG///
      ...
      log.info("End ComCompanyController.update()... ");
    }
  }
  ...
  @ApiOperation(value = "Delete ComCompany", response = void.class)
  @ApiResponses(
      value = {
        @ApiResponse(code = 400, message = "Something went wrong"),
        @ApiResponse(code = 403, message = "Access denied"),
  ...
  public ResponseEntity<ResponseModel> delete(@PathVariable("id") int id) {
    ...
    /// FOR LOG///
    try {
      log.info("Start ComCompanyController.delete()... ");
      ComCompanyDto dtoFromDb = companyService.getById(id);
      if (dtoFromDb != null) {
        dtoFromDb.setUpdateBy(oauthUser.oauthUserId());
        dtoFromDb.setUpdateDt(new Date());
      ...
      log.error("Error ComCompanyController.delete()... " + e.getMessage());
      ...
      loggingServiceClient.activityLog(
          ...
          status);
      // ***END ACTIVITY LOG***//
      log.info("End ComCompanyController.delete()... ");
    }
  }
}
