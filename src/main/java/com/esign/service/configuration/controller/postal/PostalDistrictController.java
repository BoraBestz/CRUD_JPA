...
import com.esign.service.configuration.service.postal.PostalDistrictService;
...
@Api(tags = "District")
@Slf4j
public class PostalDistrictController extends LoggingService {

  private PostalDistrictService districtService;
  ...
  @Autowired
  public void setPostalDistrictController(
      PostalDistrictService districtService,
  ...
  @PreAuthorize("isAuthenticated()")
  @GetMapping("/district")
  @ApiOperation(value = "Search District", response = PostalDistrictDto.class, responseContainer = "List")
  @ApiResponses(
      value = {
  ...
  public ResponseEntity<ResponseModel> searchByCri(
    ...
    try {
      log.info("Start PostalDistrictController.searchByCri()... ");
      PostalDistrictDto dto = modelMapper.map(paramDto, PostalDistrictDto.class);
      Page<PostalDistrictDto> byCri = districtService.findByCri(dto);
      ...
      log.error("Error PostalDistrictController.searchByCri()... " + e.getMessage());
      ...
      loggingServiceClient.activityLog(
          ...
          status);
      // ***END ACTIVITY LOG***//
      log.info("End PostalDistrictController.searchByCri()... ");
    }
  }
  ...
  @ApiOperation(value = "Get District By Id", response = PostalDistrictDto.class)
  @ApiResponses(
      value = {
        @ApiResponse(code = 400, message = "Something went wrong"),
        @ApiResponse(code = 403, message = "Access denied"),
  ...
  public ResponseEntity<ResponseModel> getById(@PathVariable("id") int id) {
    ...
    /// FOR LOG///
    try {
      log.info("Start PostalDistrictController.getById()... ");
      PostalDistrictDto dto = districtService.getById(id);

      if (dto.getId() > 0) {

        dto.setPostalCode(postalCodeService.findByDistrictId(dto.getCode()));
        dto.setPostalSubDistrict(postalSubDistrictService.findByDistrictId(dto.getId()));
      ...
      log.error("Error PostalDistrictController.getById()... " + e.getMessage());
      ...
      loggingServiceClient.activityLog(
          ...
          status);
      // ***END ACTIVITY LOG***//
      log.info("End PostalDistrictController.getById()... ");
    }
  }
  ...
  @ApiOperation(value = "New District", response = void.class)
  @ApiResponses(
      value = {
        @ApiResponse(code = 400, message = "Something went wrong"),
        @ApiResponse(code = 403, message = "Access denied"),
  ...
  public ResponseEntity<ResponseModel> create(@RequestBody PostalDistrictDto dto) {
    /// FOR LOG///
    int status = 0;
    String remark = "";
    /// FOR LOG///
    try {
      log.info("Start PostalDistrictController.create()... ");

      int count = districtService.checkDuplicateCode(dto);
      ...
      dto.setStatus("A");
      PostalDistrictEntity save = districtService.save(dto);
      ...
      log.error("Error PostalDistrictController.create()... " + e.getMessage());
      ...
      loggingServiceClient.activityLog(
          ...
          status);
      // ***END ACTIVITY LOG***//
      log.info("End PostalDistrictController.create()... ");
    }
  }
  ...
  @PreAuthorize("isAuthenticated()")
  @PutMapping("/district")
  @ApiOperation(value = "Update District", response = void.class)
  @ApiResponses(
      value = {
        @ApiResponse(code = 400, message = "Something went wrong"),
        @ApiResponse(code = 403, message = "Access denied"),
  ...
  public ResponseEntity<ResponseModel> update(@RequestBody PostalDistrictDto dto) {
    /// FOR LOG///
    int status = 0;
    String remark = "";
    PostalDistrictDto dtoFromDb = null;
    PostalDistrictDto dtoFromDbCurrentData = null;
    /// FOR LOG///
    try {
      log.info("Start PostalDistrictController.update()... ");
      dtoFromDb = districtService.getById(dto.getId());
      ...
      if (dtoFromDb.getId() > 0) {
        if (dto.getNameTh() != null
          ...
          if(dto.getProvinceId() == null || dto.getProvinceId() ==0) dto.setProvinceId(dtoFromDb.getProvinceId());
        ...
        districtService.save(dtoFromDb);
      ...
      log.error("Error PostalDistrictController.update()... " + e.getMessage());
      ...
      log.info("End PostalDistrictController.update()... ");
    }
  }
  ...
  @ApiOperation(value = "Delete District", response = void.class)
  @ApiResponses(
      value = {
        @ApiResponse(code = 400, message = "Something went wrong"),
        @ApiResponse(code = 403, message = "Access denied"),
  ...
  public ResponseEntity<ResponseModel> delete(@PathVariable("id") int id) {
    ...
    /// FOR LOG///
    try {
      log.info("Start PostalDistrictController.delete()... ");
      PostalDistrictDto dtoFromDb = districtService.getById(id);
      if (dtoFromDb != null) {
        dtoFromDb.setUpdateBy(oauthUser.oauthUserId());
        dtoFromDb.setUpdateDt(new Date());
      ...
      log.error("Error PostalDistrictController.delete()... " + e.getMessage());
      ...
      loggingServiceClient.activityLog(
          ...
          status);
      // ***END ACTIVITY LOG***//
      log.info("End PostalDistrictController.delete()... ");
    }
  }
}
