...
import com.esign.service.configuration.service.DeliveryTypeService;
...
@Api(tags = "DeliveryType")
@Slf4j
public class DeliveryTypeController extends LoggingService {
    ...
    @Autowired
    public void setDeliveryTypeController(
    ...
    @PreAuthorize("isAuthenticated()")
    @GetMapping("/delivery/type/{id}")
    @ApiOperation(value = "Get DeliveryType By Id", response = DeliveryTypeDto.class)
    @ApiResponses(
            value = {
    ...
    public ResponseEntity<ResponseModel> getById(@PathVariable("id") int id) {
        ...
        /// FOR LOG///
        try {
            log.info("Start DeliveryTypeController.getById()... ");
            DeliveryTypeDto dto = deliveryTypeService.getById(id);

            if (dto.getDeliveryTypeId() > 0) {
                /// FOR LOG///
            ...
            log.error("Error DeliveryTypeController.getById()... " + e.getMessage());
            ...
            loggingServiceClient.activityLog(
                    ...
                    status);
            // ***END ACTIVITY LOG***//
            log.info("End DeliveryTypeController.getById()... ");
        }
    }
    ...
    @ApiOperation(value = "New DeliveryType", response = void.class)
    @ApiResponses(
            value = {
                    @ApiResponse(code = 400, message = "Something went wrong"),
                    @ApiResponse(code = 403, message = "Access denied"),
    ...
    public ResponseEntity<ResponseModel> create(@RequestBody DeliveryTypeDto dto) {
        /// FOR LOG///
        int status = 0;
        String remark = "";
        /// FOR LOG///
        try {
            log.info("Start DeliveryTypeController.create()... ");

            int count = deliveryTypeService.checkDuplicateCode(dto);
            ...
            dto.setStatus(1);
            DeliveryTypeEntity save = deliveryTypeService.save(dto);

            /// FOR LOG///
            status = HttpStatus.OK.value();
            remark = "ID=" + save.getDeliveryTypeId() + " NAME=" + save.getDeliveryTypeCode();
            /// FOR LOG///

            return HelperUtils.responseSuccess(save.getDeliveryTypeId());
        } catch (BusinessServiceException e) {
            log.error("Error DeliveryTypeController.create()... " + e.getMessage());

            /// FOR LOG///
            status = e.getHttpStatus().value();
            remark = e.getMessage() + " NAME=" + dto.getDeliveryTypeCode();
            /// FOR LOG///
            ...
            loggingServiceClient.activityLog(
                    ...
                    status);
            // ***END ACTIVITY LOG***//
            log.info("End DeliveryTypeController.create()... ");
        }
    }
    //@PreAuthorize("hasAnyAuthorityCustom('ARMTE')")
    @PreAuthorize("isAuthenticated()")
    @PutMapping("/delivery/type")
    @ApiOperation(value = "Update DeliveryType", response = void.class)
    @ApiResponses(
            value = {
                    @ApiResponse(code = 400, message = "Something went wrong"),
                    @ApiResponse(code = 403, message = "Access denied"),
    ...
    public ResponseEntity<ResponseModel> update(@RequestBody DeliveryTypeDto dto) {
        /// FOR LOG///
        int status = 0;
        String remark = "";
        DeliveryTypeDto dtoFromDb = null;
        DeliveryTypeDto dtoFromDbCurrentData = null;
        /// FOR LOG///
        try {
            log.info("Start DeliveryTypeController.update()... ");
            dtoFromDb = deliveryTypeService.getById(dto.getDeliveryTypeId());
            ...
            if (dtoFromDb.getDeliveryTypeId() > 0) {
                if (dto.getDeliveryTypeCode() != null
                        && !dtoFromDb.getDeliveryTypeCode().equalsIgnoreCase(dto.getDeliveryTypeCode())) {
                    int count = deliveryTypeService.checkDuplicateCode(dto);
                    if (count > 0) {
                        throw new BusinessServiceException(
                                HttpStatus.CONFLICT, message.getMessage("ERM0002"), "ERM0002");
                ...
                deliveryTypeService.save(dtoFromDb);
            ...
            log.error("Error DeliveryTypeController.update()... " + e.getMessage());

            /// FOR LOG///
            status = e.getHttpStatus().value();
            remark = e.getMessage() + " ID=" + dto.getDeliveryTypeId();
            /// FOR LOG///
            ...
            log.info("End DeliveryTypeController.update()... ");
        }
    }

    //@PreAuthorize("hasAnyAuthorityCustom('ARMTD')")
    @PreAuthorize("isAuthenticated()")
    @DeleteMapping("/delivery/type/{id}")
    @ApiOperation(value = "Delete DeliveryType", response = void.class)
    @ApiResponses(
            value = {
                    @ApiResponse(code = 400, message = "Something went wrong"),
                    @ApiResponse(code = 403, message = "Access denied"),
    ...
    public ResponseEntity<ResponseModel> delete(@PathVariable("id") int id) {
        ...
        /// FOR LOG///
        try {
            log.info("Start DeliveryTypeController.delete()... ");
            DeliveryTypeDto dtoFromDb = deliveryTypeService.getById(id);
            if (dtoFromDb != null) {
                dtoFromDb.setUpdateBy(oauthUser.oauthUserId());
                dtoFromDb.setUpdateDt(new Date());
            ...
            log.error("Error DeliveryTypeController.delete()... " + e.getMessage());
            ...
            loggingServiceClient.activityLog(
                    ...
                    status);
            // ***END ACTIVITY LOG***//
            log.info("End DeliveryTypeController.delete()... ");
        }
    }
    ...
    @ApiOperation(value = "Search DeliveryType", response = DeliveryTypeDto.class, responseContainer = "List")
    @ApiResponses(
            value = {
                    @ApiResponse(code = 400, message = "Something went wrong"),
                    @ApiResponse(code = 403, message = "Access denied"),
    ...
    public ResponseEntity<ResponseModel> searchByCri(
            ...
            @RequestParam(required = false, defaultValue = "deliveryTypeCode", value = "sort") String sort,
        ...
        try {
            log.info("Start DeliveryTypeController.searchByCri()... ");
            DeliveryTypeDto dto = modelMapper.map(paramDto, DeliveryTypeDto.class);
            Page<DeliveryTypeDto> byCri = deliveryTypeService.findByCri(dto);
            ...
            log.error("Error DeliveryTypeController.searchByCri()... " + e.getMessage());
            ...
            loggingServiceClient.activityLog(
                    ...
                    status);
            // ***END ACTIVITY LOG***//
            log.info("End DeliveryTypeController.searchByCri()... ");
        }
    }
