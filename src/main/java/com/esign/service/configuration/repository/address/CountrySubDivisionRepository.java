...
@Repository
public interface CountrySubDivisionRepository
    extends JpaRepository<CountrySubDivisionEntity, Integer>,
        JpaSpecificationExecutor<CountrySubDivisionEntity> {

  List<CountrySubDivisionEntity> findAllByStatus(String status);
  List<CountrySubDivisionEntity> findAllByCountryIdAndCountrySubDivisionCodeAndStatus(Integer countryId,String code, String status);
  List<CountrySubDivisionEntity> findAllByCountryIdAndStatus(Integer id, Integer status);
  List<CountrySubDivisionEntity> findAllByCountrySubDivisionId(int id);
  List<CountrySubDivisionEntity> findAllByCountryId(int id);
