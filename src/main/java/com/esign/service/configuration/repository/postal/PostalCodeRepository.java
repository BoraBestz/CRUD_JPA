...
public interface PostalCodeRepository
    extends JpaRepository<PostalCodeEntity, Integer>,
        JpaSpecificationExecutor<PostalCodeEntity> {

  //List<PostalCodeEntity> findAllByStatus(String status);
  List<PostalCodeEntity> findAllBySubDistrictIdAndPostalCode(Integer subId, String code);
  List<PostalCodeEntity> findAllByDistrictId(int id);
  List<PostalCodeEntity> findAllByProvinceId(int id);
  List<PostalCodeEntity> findAllBySubDistrictId(int id);
