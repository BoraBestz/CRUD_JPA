...
@Repository
public interface PostalProvinceRepository
    extends JpaRepository<PostalProvinceEntity, Integer>,
        JpaSpecificationExecutor<PostalProvinceEntity> {

  //List<PostalProvinceEntity> findAllByStatus(String status);
  List<PostalProvinceEntity> findAllByNameTh(String nameTh);
