...
@Repository
public interface CitySubDivisionRepository
    extends JpaRepository<CitySubDivisionEntity, Integer>,
        JpaSpecificationExecutor<CitySubDivisionEntity> {

  List<CitySubDivisionEntity> findAllByStatus(String status);
  List<CitySubDivisionEntity> findAllByCityIdAndCitySubDivisionCodeAndStatus(Integer countryId,String code, int status);
  List<CitySubDivisionEntity> findAllByCityIdAndStatus(Integer cityId, int status);
